$("._tab").click((function(){let t=$(this).parents("._tabs-parent"),a=$(this).attr("data-tab");console.log(t),$(t).find("._tab").removeClass("_active"),$(this).addClass("_active"),$(t).find(".tab-content").removeClass("_active"),$(t).find("."+a).addClass("_active")})),$(".favourite-btn").click((function(){$(this).toggleClass("_added")}));
$("._toggle-mob-menu").click((function(){$(".header").toggleClass("_open"),$("body").toggleClass("fixed-body")}));
...
$(".file-input input").change((function(){const e=this.files[0];let t=$(this);if(e){let i=new FileReader;i.onload=function(e){$(t).parents(".file-input").find(".file-input__preview img").attr("src",e.target.result),$(t).parents(".file-input").addClass("_uploaded")},i.readAsDataURL(e)}}));
